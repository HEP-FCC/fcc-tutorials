...
The description of the componentes of a particle detector can be extremely complex. `DD4hep` exploits the properties of `xml` file format to store the geometry and materials of each component of a given detector hierarchically. Thus the detector description is given in one or more `xml` files.

 In this section, the following topics are covered:
* how tow to simulate an existing detector model
...
If everything goes fine, the contents of your working directory are like this:
...
1. Browse the [DD4hep documentation](https://dd4hep.web.cern.ch/dd4hep/)
