...
processList = {
    # Run over the full statistics from stage2 input file <inputDir>/xx.root.
...
# Add MySample_p8_ee_ZH_ecm240 as it is not an official process
procDictAdd = {
...
# Dictionary of the list of cuts. The key is the name of the selection that
